    ...
    return (
      <div className="game-container">
        <div className="game-over-card">
          ...
          <p className="final-score">Final Score: <span className="score-highlight">{score}</span></p>
    ...
    <div className="game-container">
      <div className="game-card">
        <div className="header">
          ...
          <p className="instructions">Click the button that matches the last (rightmost) color!</p>
        </div>
          ...
          <div className="colors-display">
            {colors.length === 0 ? (
              ...
              colors.map((color, index) => (
                <div
                  key={index}
                  className={`color-box ${color} ${index === colors.length - 1 ? 'last-color' : ''}`}
        ...
        <div className="game-info">
          ...
          <p>New colors appear every second. Game ends if array reaches 7 items or you click wrong!</p>
        </div>
      </div>
    </div>
  );
